      ...
      >
        <div className={styles.grid}>
          <div className={styles.col}>
            <h2 className={styles.cta}>{t('footer.cta')}</h2>
            <a href={`mailto:${info.email}`} className={styles.email}>{info.email}</a>
            <p className={styles.text}>{t('footer.credibility')}</p>
          </div>
          ...
          <div className={styles.links}>
            ...
            <div className={styles.linkGroup}>
              ...
              <p className={styles.text}>{info.location || t('footer.basedIn')}</p>
              <p className={styles.text}>{info.credibility || t('footer.availableWorldwide')}</p>
            </div>
          </div>
        </div>
